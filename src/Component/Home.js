                ...
                <Slide easing="ease" indicators={false}  >
                    <div className="each-slide">
                        <div style={{ backgroundImage: `url(${slide1})` }}>
                            <span>Chào mừng bạn đến với GREAT FOOD  </span>
                    ...
                    <div className="each-slide">
                        <div style={{ backgroundImage: `url(${slide2})` }}>
                            <span>Ở đây chúng tôi có những món ăn tuyệt vời cho mọi người.</span>
    ...
    return (
        <div className="body">
            ...
            <Alert show={show} variant="success">
                ...
                <p>
                    Nhà hàng Great Food chúng tôi là một nhà hàng tuyệt vời có thể tự tin khiến những khách hàng khó tính nhất cũng phải thốt lên "Ơ mây zing, gút chóp em".<br />
            ...
            <div style={{ backgroundImage: `url(${bg2})`, textAlign: 'center' }}>
                <Container>
                    ...
                    <p className="mota">Chúng tôi gợi ý cho bạn một số món ăn đã trở thành
                    ...
                    <Row >
                        <Col style={{ display: 'flex', flexDirection: 'row', paddingBottom: 10, }} md={4}>
                            ...
                            <Col className="descrepInfor" md={8} xs={10} style={{ paddingLeft: 20 }}>
                                ...
                                <Row style={{ height: '50%' }}>0835070557</Row>
                            </Col>
                        </Col>
                        <Col style={{ display: 'flex', flexDirection: 'row', paddingBottom: 10 }} md={4}>
                            <Col md={4} xs={2}>
                            ...
                            <Col className="descrepInfor" md={8} xs={10} style={{ paddingLeft: 20 }}>
                                ...
                                <Row style={{ height: '50%' }}>dinhduc2406@gmail.com</Row>
                            </Col>
                        </Col>
                        <Col style={{ display: 'flex', flexDirection: 'row', paddingBottom: 10 }} md={4}>
                            <Col md={4} xs={2}>
                            ...
                            <Col className="descrepInfor" md={8} xs={10} style={{ paddingLeft: 20 }}>
                                <Row style={{ height: '50%', fontWeight: 'bold' }}>Địa chỉ nhà hàng</Row>
                                <Row style={{ height: '50%', }}>100 Nguyễn Thức Tự - Đà Nẵng </Row>
                            </Col>
                        </Col>
                    </Row>
                </Container>
