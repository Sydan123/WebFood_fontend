    ...
    return (
      <div className="footer" >
          ...
          <Container>
            <Row>
              ...
              <Col md={4} sm={12}>
                ...
                <ul>
                  <li>
                    <p>Địa chỉ : 100 Nguyễn Thức Tự - Hòa Hải - Quận Ngũ Hành Sơn - Thành phố Đà Nẵng</p>
                  </li>
                  <li>
                    <p>Điện thoại : 0835070557 - 0847210338</p>
                  </li>
                  <li>
                    <p>Email : dinhduc2406@gmail.com</p>
                  </li>
        ...
        <div style={{ width: '100%', height: 25, backgroundColor: "#5b5b5b", color: 'white', textAlign: 'center' }}>
          <p> Copyright 2022 © Hoang Dinh Duc </p>
        </div>
      </div>
    )
  }
          ...
          <Navbar className="header-nav" style={top ? { width: '100%' } : { position: 'fixed', width: '100%', top: 0, elevation: 10, zIndex: 100 }} collapseOnSelect expand="lg" bg="danger" variant="dark" >
            ...
            <Navbar.Collapse id="navbarScroll" >
              ...
              <Form className="d-flex">
                <FormControl
                  type="search"
                  placeholder="Món ăn bạn muốn tìm kiếm..."
                  className="mr-2"
                  aria-label="Search"
                />
